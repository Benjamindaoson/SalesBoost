...
async def _start_background_tasks() -> None:
    try:
        from .engine.coordinator.task_executor import background_task_manager
...
async def _init_metrics() -> None:
    try:
        ...
        from .observability.metrics.business_metrics import performance_metrics_collector
...
async def _init_audit() -> None:
    try:
        ...
        try:
            from .services.audit_service import initialize_plugin  # type: ignore
            if callable(initialize_plugin):
                initialize_plugin()
            from .services.memory_stats_service import initialize_plugin as init_memory_stats  # type: ignore

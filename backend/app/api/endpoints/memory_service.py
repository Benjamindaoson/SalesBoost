...
from ...agents.roles.compliance_agent import ComplianceAgent
from ...infra.events.bus import bus
from ...infra.events.schemas import EventType, MemoryOutcomeEventPayload
...
async def _cross_encode_rerank(
    ...
    try:
        ...
        if settings.BGE_RERANKER_ENABLED:
            try:
                from ...infra.search.vector_store import BGEReranker, SearchResult

...
from ..tools.errors import ToolNotFoundError, ToolPermissionError
...
def build_default_registry() -> ToolRegistry:
    ...
    from ..tools.crm_integration import CRMIntegrationTool
    from ..tools.outreach.sms_tool import SMSOutreachTool

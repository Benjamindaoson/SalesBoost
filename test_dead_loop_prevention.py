...
async def test_dead_loop_prevention():
    ...
    try:
        # Import the system
        from app.services.dead_loop_prevention import dead_loop_detector, loop_intervention_handler, LoopDetectionLevel
...
async def test_extreme_scenarios():
    ...
    try:
        from app.services.dead_loop_prevention import dead_loop_detector, LoopDetectionLevel

...
async def test_cost_control_system():
    ...
    try:
        from app.services.cost_control import cost_optimized_caller, ModelCostCalculator
...
async def test_performance_metrics_system():
    ...
    try:
        from app.services.performance_metrics import performance_metrics_collector, MetricType

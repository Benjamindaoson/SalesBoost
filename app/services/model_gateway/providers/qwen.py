"""
Qwen Provider Implementation (Mock/Stub)
"""
import time
import logging
...
class QwenProvider(BaseProvider):
    """Qwen Provider (Stub - 需要真实 API key 时再实现)"""
    ...
    def __init__(self, config: ModelConfig, api_key: Optional[str] = None):
        ...
        # self.client = AsyncDashScope(api_key=api_key)
    ...
    async def chat(
        ...
        **kwargs
        ...
        content = f"[Qwen Mock] Response to: {messages[-1]['content'][:50]}..."
